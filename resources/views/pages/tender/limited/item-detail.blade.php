<table class="clean-table">
    ...
    @foreach($item->codes as $ci => $code)
        <tr class="data-item-classifier">
            <th>Класифікатор <span class="@if ($code->classifier->alias == 'cpv') item-classification.scheme @else item-additionalClassifications.scheme @endif data-item-classifier-scheme" data-item-classifier-scheme="{{$code->classifier->scheme}}">{{$code->classifier->name}}</span></th>
